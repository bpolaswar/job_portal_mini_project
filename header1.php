...
<ul class="nav">
	...
	<li><a href="update.php">Update</a></li>
					...
					<a style="letter-spacing: 2px; float:right; font-size:10px; color:white; text-decoration:none;" href="logout.php">Welcome&nbsp;<?php echo $rws['firstname'];?>&nbsp;<span>|</span>&nbsp;Logout</a>
					<?php
						}
					?>
